...
class XMLBuilder:
    ...
    def __init__(
        ...
        with open(f'{hop_config}/hop-config.json', encoding='utf-8') as file:
        ...
        self.project_folder = f'{project["projectHome"]}'
        ...
        for env_file in env['configurationFiles']:
            with open(f'{hop_config}/{env_file}', encoding='utf-8') as file:
